...
public class Nonuple<R, S, T, U, V, W, X, Y, Z>
    ...
    @Override public <A> Nonuple<A, S, T, U, V, W, X, Y, Z> mapFirst(Mapper<R, A> mapper) {
    ...
    @Override public <A> Nonuple<R, A, T, U, V, W, X, Y, Z> mapSecond(Mapper<S, A> mapper) {
    ...
    @Override public <A> Nonuple<R, S, A, U, V, W, X, Y, Z> mapThird(Mapper<T, A> mapper) {
    ...
    @Override public <A> Nonuple<R, S, T, A, V, W, X, Y, Z> mapFourth(Mapper<U, A> mapper) {
    ...
    @Override public <A> Nonuple<R, S, T, U, A, W, X, Y, Z> mapFifth(Mapper<V, A> mapper) {
    ...
    @Override public <A> Nonuple<R, S, T, U, V, A, X, Y, Z> mapSixth(Mapper<W, A> mapper) {
    ...
    @Override public <A> Nonuple<R, S, T, U, V, W, A, Y, Z> mapSeventh(Mapper<X, A> mapper) {
    ...
    @Override public <A> Nonuple<R, S, T, U, V, W, X, A, Z> mapEighth(Mapper<Y, A> mapper) {
    ...
    public <A> Nonuple<R, S, T, U, V, W, X, Y, A> mapNinth(Mapper<Z, A> mapper) {
        return mapNinth(mapperUnaryFunction(mapper));
    }
