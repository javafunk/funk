...
public class Quadruple<R, S, T, U>
    ...
    @Override public <A> Quadruple<A, S, T, U> mapFirst(Mapper<R, A> mapper) {
    ...
    @Override public <A> Quadruple<R, A, T, U> mapSecond(Mapper<S, A> mapper) {
    ...
    @Override public <A> Quadruple<R, S, A, U> mapThird(Mapper<T, A> mapper) {
